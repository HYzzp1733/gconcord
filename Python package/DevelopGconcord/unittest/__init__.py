...
class GconcordTestCase(unittest.TestCase):
    ...
    def testIsta(self):
        ...
        lam1 = 0.2
        lam2 = 0.05
        omega = gconcord.gconcord(S, lam1, lam2, method = "ista")
    ...
    def testFista(self):
        ...
        lam1 = 0.2
        lam2 = 0.05
        omega = gconcord.gconcord(S, lam1, lam2, method = "fista")
        ans = np.array([[ 1.521808, -0.428711,  0.000000,  0.000000,  0.000000,  0.000000],
    ...
    def testCwd(self):
        ...
        lam1 = 0.2
        lam2 = 0.05
        omega = gconcord.gconcord(S, lam1, lam2, method = "coordinatewise")
        ans = np.array([[ 1.521808, -0.428711,  0.000000,  0.000000,  0.000000,  0.000000],
                        [-0.428711,  3.076337,  0.000000,  0.283426,  0.000000,  0.000000],
